...
{{< slideshow >}}
  {{< slide src="TFP3D/smol_tfp_side.png" caption="Front View" >}} 
  {{< slide src="TFP3D/TFPthicc.png" caption="Back View" >}}
{{< /slideshow >}}
...
{{< slideshow >}}
  {{< slide src="TFP3D/CAD3.jpg" caption="CAD Model Rendered" >}}
  {{< slide src="TFP3D/CAD1.jpg" caption="CAD Model Base" >}} 
  {{< slide src="TFP3D/CAD2.jpg" caption="CAD Model Glasses" >}}
{{< /slideshow >}}
...
{{< slideshow >}}
  {{< slide src="TFP3D/first-print.jpg" caption="First 3D Print" >}} 
  {{< slide src="TFP3D/first-print2.jpg" caption="First 3D Print" >}}
  {{< slide src="TFP3D/tfp-unpainted-jar.jpg" caption="fatass dont fit in the jar" >}}
  {{< slide src="TFP3D/bruh-now-he-fits.jpg" caption="bruh now he fits" >}}
  {{< slide src="TFP3D/family-unpainted.jpg" caption="i made like a lot or sum" >}}
  {{< slide src="TFP3D/back-in-the-jar.jpg" caption="Back in the Jar" >}}
  {{< slide src="TFP3D/lmao-cant-escape.jpg" caption="lmao cant escape" >}}
  {{< slide src="TFP3D/family.jpg" caption="Family Photo" >}}
{{< /slideshow >}}
